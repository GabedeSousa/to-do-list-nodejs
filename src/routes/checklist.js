...
router.get('/:id/edit', async (req, res) => {
    try {
        ...
        res.status(500).render('pages/error', { errors: 'Lista nao foi encontrada para fazer edicao' });
    }
})
...
router.delete('/:id',async (req, res) => {
    ...
    try{
        ...
        res.status(500).render('pages/error', { error: 'Erro deletar as listas de tarefa' });
    }
})
